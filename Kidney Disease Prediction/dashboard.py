...
def load_data():
    try:
        uploaded_file = 'https://raw.githubusercontent.com/PalesaMonica/data-science-interest-group-deployments/refs/heads/main/Kidney%20Disease%20Prediction/kidney_disease_dataset.csv'
